...
class Dataset_Pred(Dataset):
    ...
    def __len__(self):
        return max(0, len(self.data_x) - self.seq_len + 1)
...
class Dataset_Exchange_Rate(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 ...
                 target='OT', scale=True, timeenc=0, freq='d', train_only=False):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
            self.seq_len = 24 * 4 * 4
...
class Dataset_National_Illness(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='national_illness.csv',
                 target='OT', scale=True, timeenc=0, freq='w', train_only=False):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
            self.seq_len = 24 * 4 * 4
    ...
    def __getitem__(self, index):
        ...
        return (
            ...
            np.asarray(seq_y, dtype=np.float32),
            np.asarray(seq_x_mark, dtype=np.float32),
            np.asarray(seq_y_mark, dtype=np.float32)
        )
...
class Dataset_Traffic(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='reduced_traffic_12280.csv',
                 target='OT', scale=True, timeenc=0, freq='h', train_only=False):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
